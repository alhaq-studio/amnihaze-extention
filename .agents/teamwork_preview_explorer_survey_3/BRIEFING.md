...
## Mission
Investigate MV3 compliance across Chrome and Firefox (incognito split, CSP, offscreen documents, DNR rules, web accessible resources for TFJS/NSFWJS) and evaluate test runner & mock setup for upgrading to Vitest/Jest.
...
- **Explored paths**: [TBD]
- **Key findings**: [TBD]
- **Unexplored areas**: [manifest.json, package.json, test runner config, offscreen/DNR/CSP/incognito setup, web accessible resources]
